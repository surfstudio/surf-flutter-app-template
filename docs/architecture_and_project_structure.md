...
- core - contains files that are basic for building each feature in the project. That is, the architecture of each feature of the project is fixed in the core folder, and the basic blocks for its construction are located.
