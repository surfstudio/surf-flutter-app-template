...
5. Execute command to create a new project in Firebase or select existing and specify supported platforms:
   ```sh
   flutterfire configure -p name_or_id_of_your_project --platforms android,ios -i your.ios.bundleId -a your.android.package.name
   ```
    ...
    If you want to create Firebase apps for certain flavor (e.g. dev flavor), you can modify `flutterfire configure` command like this:
    ```sh
