...
следует в явном виде передавать его в конструктор WidgetModel для получения актуального стека навигации. В свою очередь, AppRouter хранится в AppScope зависимостях и достается оттуда.
